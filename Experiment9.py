# Process the results of Experiment 9 and visualize them

import pandas as pd
import matplotlib.pyplot as plt

# Read the results of experiment 9, The absolute path needs to be changed during testing
df = pd.read_csv('/Users/yzgxy96/IdeaProjects/MyProject/Experiment9_Results.csv')

plt.figure(figsize=(10, 6))
plt.scatter(df['Estimated Theoretical Comparisons'], df['Actual Comparisons'], label='Data Points', color='blue', s=5)
...
plt.legend()
plt.savefig('Experiment9_Figure1.png')
plt.show()
