# Process the results of Experiment 7 and visualize them
import pandas as pd
import matplotlib.pyplot as plt

# Read the results of experiment 7, The absolute path needs to be changed during testing
df = pd.read_csv('/Users/yzgxy96/IdeaProjects/MyProject/Experiment7_Results.csv')
...
plt.legend()
plt.savefig('Experiment7_Figure1.png')
plt.show()
