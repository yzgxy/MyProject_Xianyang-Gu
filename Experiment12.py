# Process the results of Experiment 12 and visualize them
import pandas as pd
import matplotlib.pyplot as plt

# Read the results of experiment 12, The absolute path needs to be changed during testing
df = pd.read_csv('/Users/yzgxy96/IdeaProjects/MyProject/Experiment12_Results.csv')
...
plt.legend()
plt.savefig('Experiment12_Results.png')
plt.show()
